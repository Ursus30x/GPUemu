...
typedef struct GpuState {
    ...
    uint32_t zbuffer_addr;              // 0x30
    uint32_t int_status;                // 0x34
    uint32_t int_mask;                  // 0x38
    uint32_t dma_addr;                  // 0x3C
    uint32_t dma_vram;                  // 0x40
    uint32_t dma_size;                  // 0x44
    uint32_t dma_cmd;                   // 0x48
