...
VOID Test3DTriangles(){
    ...
    // --- Data Definitions ---
    UINT64 bin_vertex_shader[]   = { 0x80000916, 0x0, 0xC5010901, 0x8, 0x80010906, 0x0, 0x907, 0x0 };
    UINT64 bin_fragment_shader[] =  { 0x907, 0x0 };
