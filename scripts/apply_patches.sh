...
ln -sf "$CWD/gpu/jit/jit_atomic.h" "$CWD/qemu/hw/misc/jit_atomic.h"
ln -sf "$CWD/gpu/jit/jit_atomic.c" "$CWD/qemu/hw/misc/jit_atomic.c"
...
ln -sf "$CWD/UEFI/TestHarness"                      "$CWD/edk2/TestHarness"
